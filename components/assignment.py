...
def generate_conceptual_assignment(pdf_title, pdf_path, pdf_content):
    """Generate a real-life scenario-based conceptual assignment using RAG."""
    try:
        prompt = f"Create a real-life scenario-based conceptual assignment based on the lecture titled: '{pdf_title}'"
    ...
    if user["role"] == "student":
        ...
        if st.button("Generate Conceptual Assignment"):
            with st.spinner("Generating real-life scenario-based assignment..."):
                ...
                pdf_content = extract_text_from_pdf(selected_lecture_path)
                generated_assignment = generate_conceptual_assignment(selected_lecture_title, selected_lecture_path, pdf_content)
